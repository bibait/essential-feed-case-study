...
final class ImageCommentsSnapshotTests: XCTestCase {
    ...
    private func makeSUT() -> ListViewController {
        let bundle = Bundle(for: ImageCommentCellController.self)
        ...
        return [
            ImageCommentCellController(
                model: ImageCommentViewModel(
                    message: "The east Side Gallery is an open-air gallery in Berlin. It consists of a series of murals painted directly on a 1,316 m long remnant of the Berlin Wall, located near the centre of Berlin, an Mühlestraße in Friedrichshain-Kreuzberg. The gallery has official status as a Denkmal, or heritage-protected landmark.",
                    date: "1000 years ago",
