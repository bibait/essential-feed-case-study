...
final class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    private func getFeedResult(file: StaticString = #file, line: UInt = #line) -> FeedLoader.Result? {
        ...
        let loader = RemoteLoader(url: testServerURL, client: ephmeralClient(), mapper: FeedItemsMapper.map)
    ...
    private func getFeedImageDataResult(file: StaticString = #file, line: UInt = #line) -> FeedImageDataLoader.Result? {
        let loader = RemoteFeedImageDataLoader(client: ephmeralClient())
        trackForMemoryLeaks(loader, file: file, line: line)
    ...
    private func ephmeralClient(file: StaticString = #file, line: UInt = #line) -> HTTPClient {
